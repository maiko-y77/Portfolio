...
export default function Project({
  ...
  return (
    ...
    sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 pl-3 hover:bg-gray-200 
    group-even:pl-3 transition"
        >
          <div
      ...
      group-even:ml-[18rem]"
          >
            ...
            <ul className="flex flex-wrap mt-4 gap-2 sm:mt-auto">
              {tags.map((tag, index) => (
                <li
                  className="bg-[#33186B]/[0.7] px-3 py-1 text-[0.7rem] uppercase tracking-wider text-white
            rounded-full"
                  key={index}
                >
                  {tag}
          ...
          <Image
            ...
            quality={95}
            className="absolute rounded-t-lg top-8 -right-40 w-[28.25rem] shadow-2xl group-even:right-[initial] 
